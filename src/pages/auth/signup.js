...
import { setSession, register } from "../../utils/action";
...
export default function Signup() {
    ...
    const validate = () => {
        ...
        console.log("temp", tmp_input);

        if (!tmp_input["firstname"]) {
            isValid = false;
            errors["firstname"] = "Please enter your firstname.";
        }

        if (!tmp_input["lastname"]) {
            isValid = false;
    ...
    const clickRegisterBtn = async () => {
        if (validate()) {
            ...
            if (result.success) {
                ...
                delete result.data['encryptedData'];
            ...
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-md lg:max-w-xl">
                ...
                <div className="mt-6">
                    <div className="mb-2">
                        ...
                        />
                        <div className="text-[#ff0000] text-sm mt-1">{errors.firstname}</div>
                    </div>
                    <div className="mb-2">
                        <label
                            htmlFor="lname"
                        ...
                        <input
                            ...
                            className="block w-full px-4 py-2 mt-2 text-blue-700 bg-white border rounded-md focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                        />
                        <div className="text-[#ff0000] text-sm mt-1">{errors.lastname}</div>
                    </div>
                    <div className="mb-2">
                        <label
                            htmlFor="email"
                    ...
                    <div className="mt-6">
                        <button onClick={() => clickRegisterBtn()} className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-blue-700 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">
                            Sign Up
                        </button>
                    </div>
                    ...
                    <div className="flex mt-4">
                        <CustomGoogleAuth type='Register' parentCallback={setToastMessage} />
                    </div> */}
                </div>
